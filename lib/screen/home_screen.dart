...
final feedDataList = [
  FeedData(userName: 'User1', likeCount: 50, content: '오늘 저녁은 맛있었다.'),
  FeedData(userName: 'User2', likeCount: 24, content: '오늘 점심은 맛있었다.'),
  FeedData(userName: 'User3', likeCount: 82, content: '오늘 아침은 맛있었다.'),
  FeedData(userName: 'User4', likeCount: 92, content: '어제 저녁은 맛있었다.'),
  FeedData(userName: 'User5', likeCount: 72, content: '어제 점심은 맛있었다.'),
  FeedData(userName: 'User6', likeCount: 3, content: '어제 아침은 맛있었다.'),
  FeedData(userName: 'User7', likeCount: 0, content: '그제 저녁은 맛있었다.'),
  FeedData(userName: 'User8', likeCount: 24, content: '그제 점심은 맛있었다.'),
  FeedData(userName: 'User9', likeCount: 43, content: '그제 아침은 맛있었다.'),
];
